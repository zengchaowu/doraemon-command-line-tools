...
export default {
  add: async () => {
    ...
    copy(
      path.join(__dirname, "nuxt-windicss", "base.css"),
      path.join(styles, "base.css")
    );
    copy(
      path.join(__dirname, "nuxt-windicss", "components.css"),
      path.join(styles, "components.css")
    );
    copy(
      path.join(__dirname, "nuxt-windicss", "utilities.css"),
    ...
    let source = ts.createSourceFile(
      "config",
      readFileSync(path.join(__dirname, "nuxt-windicss", "config.js"), "utf8"),
