...
export default {
  add: async () => {
    exec(
      "yarn add pinia @pinia/nuxt @nuxtjs/composition-api @nuxtjs/axios; yarn add -D @doraemon-module/nuxt-auth @nuxtjs/router-extras@^1.1.1",
    ...
    const account = mkdirp(path.join(process.cwd(), "account"));
    copy(
