...
export default {
  add: async () => {
    exec(
      "yarn add ant-design-vue@^1.7.8;yarn add -D less@^2.3.1;yarn add -D less-loader@^5.0.0",
    ...
    const styles = mkdirp(assets, "styles");
    copy(
      path.join(__dirname, "lib", "theme.less"),
      path.join(styles, "theme.less")
    );
